...
class TestSubastaOptima(unittest.TestCase):
    def test_single_offer(self):
        ...
        mejor_asignacion, total = subasta_fuerza_bruta(A, B, n, ofertas)
        self.assertEqual(mejor_asignacion, [600,400])
        self.assertEqual(total, 340000)
    ...
    def test_no_assignment(self):
        ...
        mejor_asignacion, total = subasta_fuerza_bruta(A, B, n, ofertas)
        self.assertEqual(mejor_asignacion, [600, 400, 0, 0, 0])
        self.assertEqual(total, 480000)
